...
const index = {
	downdata1:[
			{id:"0",title:'Windows客户端',txt1:'8.17M',txt2:'Win7及以上系统',href:'#'},
			{id:"1",title:'IOS客户端',txt1:'39.2M',txt2:'IOS 8.0及以上版本',href:'#'},
			{id:"2",title:'Android客户端',txt1:'8.97M',txt2:'Android4.1及以上版本',href:'#'}
		],
	downdata2:[
			{id:"0",title:'自建代理',txt:'自建机房保证稳定安全，支持多种协议'},
			{id:"1",title:'海量资源',txt:'每天提供大量IP，满足各种需求'},
			{id:"2",title:'灵活调用',txt:'功能强大，多种API参数，提供私人定制服务'}
		],
	intro:[
		{id:'0',title:'数据采集',txt1:'爬虫突破IP限制，解决IP封禁问题',txt2:'提高抓取效率，实现各类公开合法的信息采集'},
		{id:'0',title:'网络加速',txt1:'多平台任意切换ip，一站式解决网络延迟问题',txt2:'畅游网络，体验游戏新世界'},
		{id:'0',title:'数据采集',txt1:'使用代理ip可随你注册，想有多少账号就有多少账号',txt2:'动态ip给你带来无限可能，投票刷单必备神器'},
		{id:'0',title:'数据采集',txt1:'在SEO优化、电商优化、论坛发帖等操作过程中',txt2:'对于提高工作效率上，代理ip软件取到至关重要作用'}
	], //section3
	desc:[
		{
			id:'11',
			title:'使用教程',
			img:'../assets/images/new_bg_one.png',
			data:[
				{id:'21',title:'安卓app客户端注册验证码图片不显示处理'},
				{id:'21',title:'国内动态ip代理软件哪个好？支持手机？'},
				{id:'21',title:'安卓app客户端注册验证码图片不显示'},
				{id:'21',title:'国内动态ip代理软件哪个好？支持手机？'}
			]
		},
		{
			id:'12',
			title:'常见问题',
			img:'../assets/images/new_bg_two.png',
			data:[
				{id:'31',title:'逍遥代理之程序进程代理特殊功能讲解'},
				{id:'31',title:'新手教程--IOS手机线路直连方法：'},
				{id:'31',title:'一文告诉你什么是动态ip，什么是静态i'},
				{id:'31',title:'国内动态ip代理软件哪个好？支持手机？'}
			]
		},
		{
			id:'13',
			title:'代理知识',
			img:'../assets/images/new_bg_three.png',
			data:[
				{id:'41',title:'安卓客户端不显示验证码怎么解决？'},
				{id:'41',title:'国内动态ip代理软件哪个好？支持手机？'},
				{id:'41',title:'安卓app客户端注册验证码图片不显示'},
				{id:'41',title:'国内动态ip代理软件哪个好？支持手机？'}
			]
		},
	],//section4
...
const header = {
	logo:{
		title:'逍遥代理',
		logo_n:"/static/img/logo.126bca5.png",
		logo_s:"/static/img/logo1.2a29f6b.png"
	},
	nav:[
		{id:'0',name:'首页',url:'index'},
		{id:'1',name:'套餐购买',url:'shop'},
		{id:'2',name:'软件下载',url:'xiazai'},
		{id:'3',name:'帮助中心',url:'bangzhu'},
		{id:'4',name:'关于我们',url:'about'},
	]
}
/* 帮助中心 */
const bangzhu = {
	jc:{
		...
		title:"使用教程",
		data:[
			{id:10,title:"1、安卓app客户端注册验证码图片不显示处理",time:"[04-20]"},
			{id:11,title:"2、国内动态ip代理软件哪个好？支持手机？",time:"[04-20]"},
			{id:12,title:"3、一文告诉你什么是动态ip，什么是静态i",time:"[04-20]"},
			{id:13,title:"4、经验分享——逍遥动态IP软件都能做什么",time:"[04-20]"},
			{id:14,title:"5、软件介绍--那些因素会影响代理ip速度",time:"[04-20]"},
			{id:15,title:"6、新手教程--逍遥动态ip注册软件下载",time:"[04-20]"},
			{id:16,title:"7、紧急通知——逍遥代理ip免费送会员倒计",time:"[04-20]"},
			{id:17,title:"8、逍遥代理ip免费送会员啦！！！",time:"[04-20]"},
		]
	},
	wt:{
		id:4,
		title:"常见问题",
		data:[
			{id:18,title:"1、逍遥代理之程序进程代理特殊功能讲解",time:"[04-20]"},
			{id:19,title:"2、新手教程--IOS手机线路直连方法：",time:"[04-20]"},
			{id:20,title:"3、关于我们",time:"[04-20]"},
			{id:21,title:"4、武汉重启，逍遥代理正式开工！",time:"[04-20]"},
			{id:22,title:"5、2019年逍遥代理元旦假期安排通知",time:"[04-20]"},
			{id:23,title:"6、热烈庆祝逍遥代理免费送会员活动圆满结",time:"[04-20]"},
			{id:24,title:"7、新手教程--电脑客户端使用教程",time:"[04-20]"},
			{id:25,title:"8、逍遥代理ip免费送会员啦！！！",time:"[04-20]"},
		]
	},
	zs:{
		id:5,
		title:"代理知识",
		data:[
			{id:26,title:"1、安卓客户端不显示验证码怎么解决？",time:"[04-20]"},
			{id:27,title:"2、IP代理有什么用？适用哪些场景？",time:"[04-20]"},
			{id:28,title:"3、使用代理IP，别人能查到真实地址吗?",time:"[04-20]"},
			{id:29,title:"4、高匿代理IP稳定吗？能用多久？",time:"[04-20]"},
			{id:30,title:"5、ip代理究竟什么用处",time:"[04-20]"},
			{id:31,title:"6、动态IP加速器的基本概念",time:"[04-20]"},
			{id:32,title:"7、为什么爬虫需要代理IP？",time:"[04-20]"},
			{id:33,title:"8、逍遥代理ip免费送会员啦！！！",time:"[04-20]"},
		]
	},
}
const listdata= {
	data:[
		{
			title:"逍遥代理之程序进程代理特殊功能讲解",
			id:4,
			cont:"本篇文章主要讲解逍遥动态ip代理软件的特色功能之一的程序进程代理功能。 首先我们需要搞清楚程序进程到底是个什么玩意，才能更好的明白这个特色ip代理功能。",
			time:"2020-04-13 20:48:57",
			hot:"139°C",
		},
		{
			title:"逍遥代理之程序进程代理特殊功能讲解",
	...
	tj:[
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:15},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:25},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:35},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:45},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:55},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:65},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:75},
		{title:"逍遥代理之程序进程代理特殊功能讲解",id:85}
	]
}
/* 首页轮播图 */
const carouselList = [{
